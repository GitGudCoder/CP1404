...
print("\nlowercase_full_names =",lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# TODO: use a list comprehension to create a list of integers
actual_numbers = [int(almost_number) for almost_number in almost_numbers]
print("\nalmost_numbers =",almost_numbers,"\nactual_numbers =", actual_numbers)

# TODO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers_greater_than_nine = [actual_number for actual_number in actual_numbers if actual_number > 9]
print("\nnumbers_greater_than_nine =",numbers_greater_than_nine)